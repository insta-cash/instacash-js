...
addNetwork({
  name: 'livenet',
  alias: 'mainnet',
  pubkeyhash: 0x17, //0x4c, (0x1E = 185033)
  ...
  port: 46200, // InstaCash = // PIVX = 51472,// DASH = 9999,
  dnsSeeds: [
    '199.247.11.214',
    '207.148.78.10',
    '45.77.231.53',
...
var TESTNET = {
  PORT: 46204,//51474,//19999,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0x457665ba),//0xcee2caff),
  DNS_SEEDS: [
    'instacash-testnet.seed.fuzzbawls.pw',//'testnet-seed.darkcoin.io',
    'instacash-testnet.seed2.fuzzbawls.pw',//'testnet-seed.dashdot.io',
